<template>
       ...
       <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" style="max-width: 300px;">
                        ...
                        <a style="max-width: 300px;" v-for="notification in notifications" :href="notification.data.link" class="dropdown-item" >New Notification <br> <span style="color: grey;" v-text="notification.data.message"></span></a>
